...
int main(void) {//主程序
	...
	while (1) {
		...
		if(MENU==4){
			...
			INVERSE_OLED_DISPLAY_16x16(2,0*16,21);//汉字显示	 高温
			INVERSE_OLED_DISPLAY_16x16(2,1*16,3);
			INVERSE_OLED_DISPLAY_8x16(2,4*8,10+0x30);//冒号
			...
			INVERSE_OLED_DISPLAY_16x16(2,5*16,13); //显示白面
			INVERSE_OLED_DISPLAY_16x16(2,6*16,13); //显示白面
			INVERSE_OLED_DISPLAY_16x16(2,7*16,13); //显示白面
		...
		if(MENU==5){
			...
			INVERSE_OLED_DISPLAY_8x16(4,0*16,22);//汉字显示	 低温
			INVERSE_OLED_DISPLAY_8x16(4,1*16,3);
			INVERSE_OLED_DISPLAY_8x16(4,4*8,10+0x30);//冒号
			INVERSE_OLED_DISPLAY_8x16(4,5*8,0x20);//空格
			INVERSE_OLED_DISPLAY_8x16(4, 6*8, low_temp/10+0x30);//高温十位
			INVERSE_OLED_DISPLAY_8x16(4, 7*8, low_temp%10+0x30);//高温个位
			INVERSE_OLED_DISPLAY_16x16(4, 4*16, 16);//摄氏度
			INVERSE_OLED_DISPLAY_16x16(4,5*16,13); //显示白面
			INVERSE_OLED_DISPLAY_16x16(4,6*16,13); //显示白面
			INVERSE_OLED_DISPLAY_16x16(4,7*16,13); //显示白面
		...
		if(MENU==6){
			...
			INVERSE_OLED_DISPLAY_16x16(4,0*16,8);//汉字显示	 光照
			INVERSE_OLED_DISPLAY_16x16(4,1*16,9);
			INVERSE_OLED_DISPLAY_8x16(4,4*8,10+0x30);//冒号
			INVERSE_OLED_DISPLAY_8x16(4,5*8,0x20);//空格
			INVERSE_OLED_DISPLAY_16x16(4, 3*16,13);//
		...
		if(MENU==7){
			...
			INVERSE_OLED_DISPLAY_16x16(4,0*16,5);//汉字显示	 湿度
			INVERSE_OLED_DISPLAY_16x16(4,1*16,4);
			INVERSE_OLED_DISPLAY_8x16(4,4*8,10+0x30);//冒号
			INVERSE_OLED_DISPLAY_8x16(4,5*8,0x20);//空格
			INVERSE_OLED_DISPLAY_16x16(4,3*16,13);//
			INVERSE_OLED_DISPLAY_16x16(4,4*16,13);
