...
#define EN_USART2		0 //使能（1） /禁止（0）串口1
#define EN_USART3		0 //使能（1） /禁止（0）串口1


extern u8 USART1_RX_BUF[USART1_REC_LEN]; //接受缓冲，最大USART_REC_LEN个字节，末字节为换行符
extern u8 USART2_RX_BUF[USART2_REC_LEN]; //接受缓冲，最大USART_REC_LEN个字节，末字节为换行符
extern u8 USART3_RX_BUF[USART3_REC_LEN]; //接受缓冲，最大USART_REC_LEN个字节，末字节为换行符
